...
vue и vuetify, если не сделали это на прошлом занятии. Т.к. у вас ещё нет удаленных сервисов, то используйте массивы во vuex 
для временного хранения данных(конечно они должны пропадать при закрытии браузера, но сохраняться при переходе между страницами).
